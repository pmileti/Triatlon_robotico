...
#        return(math.sqrt(self.position[0]*self.position[0]+self.position[2]*self.position[2])>lossDistance)
    ...
    def outOfDohyo(self) ->bool:
        ...
        #print(math.sqrt(self.position[0]*self.position[0]+self.position[2]*self.position[2]))
        if(math.sqrt(self.position[0]*self.position[0]+self.position[2]*self.position[2])>(lossDistance-0.05)):
...
#POSICION INICIAL
#robot0Obj.position = randomizePosition([-0.2, 0.0217, 0])
robot0Obj.position = [-0.3, 0.0217, 0.2]
### NO SE LO GIRO POR AHORA###
