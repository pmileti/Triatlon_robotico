...
function penalPressed(){
	//Send signal to penalizar pibito
	window.robotWindow.send("penal");
}
...
function setEnableButton(name, state){
	...
	//window.robotWindow.setTitle(name);
...
function lostJ1() {
	document.getElementById("winning-team").innerText = "Finalizado, calculen puntaje!"
	endGame();
}
...
function draw() {
	document.getElementById("winning-team").innerText = "Fin del tiempo! Calculen puntaje!"
	endGame();
}
