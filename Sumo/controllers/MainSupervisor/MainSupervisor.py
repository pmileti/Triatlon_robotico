"""Roboliga Supervisor Controller v1
   ...
   ...and Pablo Mileti rewrite to simulate Triatlón Robótico Torneos Bonaerenses
"""
...
robot0Obj.position = randomizePosition([-0.2, 0.0217, -0.5])  #Change by Pablo Mileti 
robot0Obj.rotation = randomizeRotation([0, 1, 0, 3.14])       #Change by Pablo Mileti
robot1Obj.position = randomizePosition([0.2, 0.0217, 0.5])    #Change by Pablo Mileti
robot1Obj.rotation = randomizeRotation([0, 1, 0, 0])
